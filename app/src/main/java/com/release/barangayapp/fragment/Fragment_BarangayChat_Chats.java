 ...
 */
public class Fragment_BarangayChat_Chats extends Fragment  implements UsersAdapter.OnUserListener {
    ...
    public Fragment_BarangayChat_Chats() {
    ...
    private void initializeAdapter() {
        userService.getChatUsers(value ->{
            userList = value;
    ...
    private void loadMore() {
        ...
        handler.postDelayed(() -> {
            ...
            messageService.loadMoreUsers(value -> {
                userIds = value;
                userService.getMoreChatUsers(updatedUsersList ->{
                    userList = updatedUsersList;
                    recyclerViewAdapter.notifyDataSetChanged();
                    isLoading = false;
                },10,userIds,userList);
