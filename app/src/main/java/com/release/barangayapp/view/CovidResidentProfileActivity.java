...
public class CovidResidentProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), CovidSymptomSurveyActivity.class));
            }
        });
        ...
        back.setOnClickListener(v -> {
            ...
            Intent back=new Intent(CovidResidentProfileActivity.this, UserMainMenu.class);
            startActivity(back);
        });
