...
public class BarangayCreateUpdatesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateAuthService.getUserDetails(value ->  {
            if(updateAuthService.getAuthUser() == null) {
                Intent homeIntent = new Intent(BarangayCreateUpdatesActivity.this, MainMenu.class);
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    Toast.makeText(BarangayCreateUpdatesActivity.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.admin_home:
                Intent home = new Intent(BarangayCreateUpdatesActivity.this, AdminMainMenuActivity.class);
                startActivity(home);
                finish();
                break;
            case R.id.admin_profile:
                Intent profile = new Intent(BarangayCreateUpdatesActivity.this, BarangayProfileActivity.class);
                startActivity(profile);
                finish();
                break;
            case R.id.admin_register:
                Intent registerIntent = new Intent(BarangayCreateUpdatesActivity.this, Register.class);
                startActivity(registerIntent);
                finish();
                break;
            case R.id.admin_logout:
                //For Signout in Firebase
                Intent LogoutIntent = new Intent(BarangayCreateUpdatesActivity.this, MainMenu.class);
